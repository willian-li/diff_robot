...
#include "diffdrive_stm/visibility_control.h"
#include "diffdrive_stm/stm32_comms.hpp"
#include "diffdrive_stm/wheel.hpp"

namespace diffdrive_stm
{
class DiffDriveStmHardware : public hardware_interface::SystemInterface
{
...
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(DiffDriveStmHardware);

  DIFFDRIVE_STM_PUBLIC
